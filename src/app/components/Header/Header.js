...
export default function Header() {
  // below is the code for the header so we can track the scroll
  // if the user scrolls down the use state will be set to true
  // and the page y offset value will be 0
    ...
    <React.Fragment>
      ...
      >
        <div className="relative">
          <div
            onClick={openDrawer}
            className="z-30 absolute cursor-pointer w-14 h-14 lg:w-24 lg:h-24 bg-[#880808] flex justify-center items-center rounded-br-3xl"
          >
